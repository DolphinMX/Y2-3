...
HD_PWD='C:/Users/EEuser/Desktop/full_adder_1bit/full_adder_1bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log full_adder_4bits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source full_adder_4bits.tcl
