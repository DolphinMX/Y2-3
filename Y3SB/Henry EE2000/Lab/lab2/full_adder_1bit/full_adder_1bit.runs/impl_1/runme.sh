...
HD_PWD='C:/Users/EEuser/Desktop/full_adder_1bit/full_adder_1bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log full_adder_4bits.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source full_adder_4bits.tcl -notrace
