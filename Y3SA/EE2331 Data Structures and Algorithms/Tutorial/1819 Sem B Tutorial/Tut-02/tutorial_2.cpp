...
string& nextWord(const char*& buffer)
{
	...
	//    nextWord(buffer) returns the string "object-oriented", and
	//    the pointer is advanced to point to the space char before the word "language"

	// Example 2
	//    buffer[] = " procedural, and functional ..."
	//    nextWord(buffer) returns the string "procedural", and
	//    the pointer is advanced to point to the space char before the word "and"
	...
	string *temp = new string();  // dummy empty string
